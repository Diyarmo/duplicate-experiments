...
def get_transformer_model_predictions(model, data_loader, device):
    predictions = []
    labels = []
...
def get_transformer_model_and_dataloader(
    model_file,
    tokenizer_file,
    ...
    test_path,
    device
    ) -> Tuple[DuplicateSiameseTransformer, DuplicateDataLoader]:
